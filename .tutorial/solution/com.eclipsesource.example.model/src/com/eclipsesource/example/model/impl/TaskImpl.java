 ...
 * </p>
 * <ul>
 *   <li>{@link com.eclipsesource.example.model.impl.TaskImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.eclipsesource.example.model.impl.TaskImpl#getSubtasks <em>Subtasks</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TaskImpl extends MinimalEObjectImpl.Container implements Task {
	...
	public NotificationChain basicSetSubtasks(Task newSubtasks, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TASK__SUBTASKS, oldSubtasks, newSubtasks);
	...
	public void setSubtasks(Task newSubtasks) {
		if (newSubtasks != subtasks) {
			...
			if (subtasks != null)
				msgs = ((InternalEObject)subtasks).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TASK__SUBTASKS, null, msgs);
			if (newSubtasks != null)
				msgs = ((InternalEObject)newSubtasks).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.TASK__SUBTASKS, null, msgs);
			msgs = basicSetSubtasks(newSubtasks, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TASK__SUBTASKS, newSubtasks, newSubtasks));
	}
